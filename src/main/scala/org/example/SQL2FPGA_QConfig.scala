...
class SQL2FPGA_QConfig{
  ...
  private var _fpgaOverlayVersion: Int = 0 //0 - 2020; 1 - 2022
  ...
  def fpgaOverlayVersion = _fpgaOverlayVersion
  ...
  def fpgaOverlayVersion_=(newValue: Int): Unit = {
    _fpgaOverlayVersion = newValue
  }
