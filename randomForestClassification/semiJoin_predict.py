...
# load dataset
input_training_dataset = pd.read_csv('semijoin_training_dataset.csv', sep=',', header=0)
input_testing_dataset = pd.read_csv("semijoin_testing_dataset.csv", sep=',', header=0)
...
comparison_results.to_csv('semijoin_test_expected.csv', index=True)  # Set index=False to exclude row numbers
