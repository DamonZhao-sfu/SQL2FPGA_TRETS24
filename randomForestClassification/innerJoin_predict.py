...
# load dataset
input_training_dataset = pd.read_csv('innerjoin_training_dataset.csv', sep=',', header=0)
# input_testing_dataset = pd.read_csv("innerjoin_testing_dataset.csv", sep=',', header=0)
input_testing_dataset = pd.read_csv("innerjoin_testing_dataset_30sf.csv", sep=',', header=0)
...
le = LabelEncoder()
X_testing.key_name = le.fit_transform(X_testing.key_name)
X_training.key_name = le.transform(X_training.key_name)
...
# print(input_testing_dataset.key_name)
# print(X_testing.key_name)
...
# comparison_results.to_csv('innerjoin_test_expected.csv', index=True)  # Set index=False to exclude row numbers

y_pred = best_clf.predict(X_testing)
accuracy = accuracy_score(y_testing, y_pred)
print("Testing Accuracy:", accuracy)
y_pred = pd.DataFrame(y_pred)
comparison_results = pd.concat([y_testing, y_pred], axis=1)
comparison_results.to_csv('innerjoin_test_expected.csv', index=True)  # Set index=False to exclude row numbers
