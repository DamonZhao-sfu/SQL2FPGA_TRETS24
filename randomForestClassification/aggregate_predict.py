...
col_names = ["record_id","operation","num_input_table","num_groupby_key","num_aggregation_ops","rowNum_input_table","colNum_input_table","rowNum_output_table","colNum_output_table","CPU(ms)","FPGA(ms)","label(0_CPU/1_FPGA)"]

# load dataset
input_training_dataset = pd.read_csv('aggregate_training_dataset.csv', sep=',', header=0)
input_testing_dataset = pd.read_csv("aggregate_testing_dataset.csv", sep=',', header=0)

#split dataset in features and target variable
feature_cols = ['num_groupby_key','num_aggregation_ops','rowNum_input_table','colNum_input_table','rowNum_output_table','colNum_output_table']
...
comparison_results.to_csv('aggregate_test_expected.csv', index=True)  # Set index=False to exclude row numbers
